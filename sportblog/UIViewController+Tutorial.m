...
#define ApplicationMainColor                [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
...
- (void)startTapTutorialWithInfo: (NSString *)infoText
    ...
    tutorialView.backgroundColor = [ApplicationMainColor colorWithAlphaComponent:hideBackground ? 1.0 : 0.5];
//    tutorialView.alpha = 0.8;
    
    [self.parentViewController.view addSubview: tutorialView];
    
    DKCircleImageView *touchView = [[DKCircleImageView alloc] initWithFrame:CGRectMake(0, 0, 50, 50)];
    
    touchView.center = touchPoint;
    
    touchView.backgroundColor = [UIColor colorWithWhite:1 alpha:0.8];
